								...
								<div class="wt-personalskillshold tab-pane active fade show personal_tab_active" id="wt-skills">
									...
									<div class="wt-yourdetails wt-tabsinfo">
										...
										<div class="wt-formtheme wt-userform">
											<fieldset>
												<div class="form-group form-group-full" id="guard_designation">
													<label>Guard Designation</label>
													<span class="wt-select">
														<select name="select_guard">
															<option value="">Select Designation</option>
															<option value="Door Supervisior">Door Supervisior</option>
												...
												<div class="form-group form-group-half price_per_hour">
													...
													<input type="text" name="price_per_hour" class="form-control" placeholder="Price Per Hour" data-required="true" autocomplete="off">
												</div>
												<div class="form-group form-group-half">
													<label>Password</label>
													<input type="password" name="guard_password" id="guard_password" class="form-control guard_password" placeholder="Password" data-required="true" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required autocomplete="off">
													<i class="fa fa-eye" id="guard_icon"></i>
													<div id="message">
														{{-- <h3>Password must contain the following:</h3> --}}
														<p id="letter" class="invalid">A <b>lowercase</b> letter</p>
														<p id="capital" class="invalid">A <b>capital (uppercase)</b> letter</p>
														<p id="number" class="invalid">A <b>number (123456)</b></p>
														<p id="length" class="invalid">Minimum <b>8 characters</b></p>
													</div>
												</div>
												<div class="form-group form-group-half">
													<label>Confirm Password</label>
													<input type="password" name="guard_confirm_password" class="form-control guard_confirm_password" placeholder="Confirm Password" data-required="true" autocomplete="off">
													<i class="fa fa-eye" id="guard_eye"></i>
													<div>
