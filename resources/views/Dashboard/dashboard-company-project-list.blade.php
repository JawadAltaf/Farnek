                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 float-right">
                    <div class="wt-dashboardbox">
                        <div class="wt-dashboardboxtitle wt-titlewithsearch">
                            <h2>Manage Company Projects</h2>
                            <a href="{{ url('add_company_project') }}" class="wt-btn float-right wt-btn-sm ml-4">
                                <i class="fa fa-plus-circle"></i>&nbsp;Add New Company Project</a>
