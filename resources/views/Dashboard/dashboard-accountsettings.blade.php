                                            ...
                                            <div class="wt-formtheme wt-userform">
                                                <fieldset>
                                                    <div class="form-group form-group-half">
                                                        ...
                                                        <input class="form-control" placeholder="Prénom" name="first_name" type="text" value="First Name">
                                                    </div>
                                                    <div class="form-group form-group-half">
                                                        <label>Last Name</label>
                                                        <input class="form-control" placeholder="Nom de famille" name="last_name" type="text" value="Last Name">
                                                    </div>
                                        ...
                                        <div class="wt-location wt-tabsinfo">
                                            ...
                                            <div class="wt-settingscontent">
                                                <div class="wt-formtheme wt-userform">
                                                    <div class="wt-uploadingbox">
                                                        <figure>
                                                            <img src="{{ asset('assets/images/sidebar/Farnek-Banner.jpg') }}" alt="Photo de profil">
                                                        </figure> 
