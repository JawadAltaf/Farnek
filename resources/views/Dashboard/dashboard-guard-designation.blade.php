					...
					<div class="wt-dashboardbox wt-categorys">
						...
						<div class="wt-dashboardboxcontent wt-categoriescontentholder">
							<table class="wt-tablecategories">
								...
								<tbody>
									<tr>
										<td><figure><img src="{{ asset('assets/images/categories/door.png') }}" alt="img description"></figure></td>
									...
									<tr>
										<td><figure><img src="{{ asset('assets/images/categories/ico_sec_concierge.png') }}" alt="img description"></figure></td>
									...
									<tr>
										<td><figure><img src="{{ asset('assets/images/categories/cctv.png') }}" alt="img description"></figure></td>
										<td>CCTV Security</td>
									...
									<tr>
										<td><figure><img src="{{ asset('assets/images/categories/ico_sec_event.png') }}" alt="img description"></figure></td>
									...
									<tr>
										<td><figure><img src="{{ asset('assets/images/categories/ico_sec_retail.png') }}" alt="img description"></figure></td>
									...
									<tr>
										<td><figure><img src="{{ asset('assets/images/categories/ico_sec_construction.png') }}" alt="img description"></figure></td>
									...
									<tr>
										<td><figure><img src="{{ asset('assets/images/categories/ico_sec_corporate.png') }}" alt="img description"></figure></td>
									...
									<tr>
										<td><figure><img src="{{ asset('assets/images/categories/ico_sec_mobile.png') }}" alt="img description"></figure></td>
									...
									<tr>
										<td><figure><img src="{{ asset('assets/images/categories/ico_sec_industrial.png') }}" alt="img description"></figure></td>
